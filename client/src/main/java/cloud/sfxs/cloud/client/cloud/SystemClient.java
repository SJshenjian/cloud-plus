...
@FeignClient(name = "system-service", contextId = "system")
public interface SystemClient {
    ...
    @GetMapping(value = "/auth/validate", produces = MediaType.APPLICATION_JSON_VALUE)
    @Operation(summary = "TOKEN鉴权", tags = "系统管理")
    ClaimsDto authValidate(@RequestHeader("Authorization") String headers);
}